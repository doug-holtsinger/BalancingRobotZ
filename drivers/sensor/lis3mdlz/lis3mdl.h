...
#ifndef ZEPHYR_DRIVERS_SENSOR_LIS3MDLZ_LIS3MDLZ_H_
#define ZEPHYR_DRIVERS_SENSOR_LIS3MDLZ_LIS3MDLZ_H_
...
#define LIS3MDL_FS_IDX                  ((CONFIG_LIS3MDLZ_FS / 4) - 1)

/* guard against invalid CONFIG_LIS3MDLZ_FS values */
#if CONFIG_LIS3MDLZ_FS % 4 != 0 || LIS3MDL_FS_IDX < -1 || LIS3MDL_FS_IDX >= 4
#error "Invalid value for CONFIG_LIS3MDLZ_FS"
#endif
...
#if defined(CONFIG_LIS3MDLZ_TRIGGER_OWN_THREAD)
	K_KERNEL_STACK_MEMBER(thread_stack, CONFIG_LIS3MDLZ_THREAD_STACK_SIZE);
	struct k_sem gpio_sem;
	struct k_thread thread;
#elif defined(CONFIG_LIS3MDLZ_TRIGGER_GLOBAL_THREAD)
	struct k_work work;
#endif

#endif /* CONFIG_LIS3MDLZ_TRIGGER */
};
