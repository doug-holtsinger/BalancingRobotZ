...
#ifdef CONFIG_LIS3MDLZ_TRIGGER_OWN_THREAD
...
#ifdef CONFIG_LIS3MDLZ_TRIGGER_GLOBAL_THREAD
...
int lis3mdl_init_interrupt(const struct device *dev)
{
	...
	k_thread_create(&drv_data->thread, drv_data->thread_stack,
			CONFIG_LIS3MDLZ_THREAD_STACK_SIZE,
			lis3mdl_thread, drv_data,
			NULL, NULL, K_PRIO_COOP(CONFIG_LIS3MDLZ_THREAD_PRIORITY),
			0, K_NO_WAIT);
#elif defined(CONFIG_LIS3MDLZ_TRIGGER_GLOBAL_THREAD)
