...
// 0 -- time between AHRS updates 
// 1 -- time between accel calibrated Y transition from > 30  to Q1 quaternion transition > 0.015
// 2 -- time between Q1 quaternion transition from >0.015 to roll > 1.8
// 3 -- time between roll > 1.8 and start of yield to motor thread.
// 4 -- time between start of yield motor thread to driver > 1800
